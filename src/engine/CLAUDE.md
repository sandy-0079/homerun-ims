...
Going live is removing the store from that list; nothing else. **Live value now: `[]`** — it was
`["DS07","DS08"]` at ship; **DS07 HAL went live 2026-09-22** (the first end-to-end run of this pass)
and **DS08 Rajajinagar on 2026-09-25**. The pass stays: it is how the next store opens.
...
- **⚠ Going live is the untick PLUS the inputs the gate was hiding.** The gate zeroes
  ...
  re-measure every time. **DS08 re-measured 2026-09-25: also inert** (0 published cells differ;
  capacity 300/150 saved at 18:53 IST, ~20 min after its 18:32 Apply).
