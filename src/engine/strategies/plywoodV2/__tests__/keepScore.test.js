...
describe('computeKeepScores', () => {
  ...
  it('computes rent and service ratios (gm = profit/sales → revenue = cost/(1−gm))', () => {
    // holding = (3+5)×1000 = 8000; carry = 8000×0.05×1.5 = 600
    // revenue = 100×1000/0.94 = 106382.98; gross profit = ×0.06 = 6382.98; rent = 6382.98/600 = 10.638
    ...
    expect(a.salesValue).toBeCloseTo(106382.98, 1);
    expect(a.rentRatio).toBeCloseTo(10.638, 2);
