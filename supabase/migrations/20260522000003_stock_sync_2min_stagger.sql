-- Increase stagger from 1 min to 2 min between stock sync jobs.
-- Prevents concurrent reads/writes to the large team_data JSONB row
-- which caused Supabase statement timeouts when functions overlapped.
--
-- IST times (UTC+5:30):
--   stock-sync-1: :35 UTC = :05 IST  — DC + DS01   (unchanged)
--   stock-sync-2: :37 UTC = :07 IST  — DS02 + DS03 (was :36)
--   stock-sync-3: :39 UTC = :09 IST  — DS04 + DS05 (was :37)
